        ...
        <div id="product">
            ...
            <div class="action pull-left">
                <div class="cart pull-left">
                    ...
                    <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-default"><?php echo $button_cart; ?></button>
                </div>
                <div class="pull-left">  
                    <button type="button" data-toggle="tooltip" class="wishlist btn btn-default dark" title="<?php echo $button_wishlist; ?>" onclick="wishlist.addwishlist('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i></button>
                </div>
                <div class="pull-left">
                    <button type="button" data-toggle="tooltip" class="compare btn btn-default dark" title="<?php echo $button_compare; ?>" onclick="compare.addcompare('<?php echo $product_id; ?>');"><i class="fa fa-exchange"></i></button>
                </div>
            </div>
        </div>
