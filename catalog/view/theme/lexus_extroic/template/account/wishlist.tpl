      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody id="wishlist-row<?php echo $product['product_id']; ?>">
          <tr>
            ...
            <td class="text-right">
            <p>
              <button type="button" onclick="cart.addcart('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" title="<?php echo $button_cart; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart"></i></button>
            </p>
