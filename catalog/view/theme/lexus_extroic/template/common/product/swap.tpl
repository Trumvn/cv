	...
	<div class="product-meta">		  
		...
		<div class="right">		
			<div class="action">
				...
				<div class="cart">						
					<a class="btn btn-outline" onclick="addToCart('<?php echo $product['product_id']; ?>');">
				...
				<?php } ?>
				<div class="compare">			
					<a class="btn btn-outline"  onclick="addToCompare('<?php echo $product['product_id']; ?>');" title="<?php echo $button_compare; ?>">
						<i class="fa fa-retweet"></i>
						<span><?php echo $button_compare; ?></span>
					</a>	
				</div>	
				<div class="wishlist">
					<a class="btn btn-outline" onclick="addToWishList('<?php echo $product['product_id']; ?>');" title="<?php echo $button_wishlist; ?>">
