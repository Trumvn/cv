	...
	<?php if ($product['thumb']) {    ?>
		<div class="image">
			...
			<?php if( isset($categoryPzoom) && $categoryPzoom ) { $zimage = str_replace( "cache/","", preg_replace("#-\d+x\d+#", "",  $product['thumb'] ));  ?>
				<a href="<?php echo $zimage;?>" class="info-view colorbox product-zoom btn btn-default cboxElement" title="<?php echo $product['name']; ?>"><i class="fa fa-search-plus"></i><span><?php echo $olang->get('zoom_product'); ?></span></a>
				<?php } ?>	
		</div>
	<?php } ?>
	...
	<div class="product-meta">		  
		...
		<div class="right">		
			<div class="action">
				...
				<div class="cart">						
					<a class="btn btn-outline"   onclick="cart.addcart('<?php echo $product['product_id']; ?>');">
				...
				<?php } ?>
				<div class="compare">			
					<a class="btn btn-outline"  onclick="compare.addcompare('<?php echo $product['product_id']; ?>');" title="<?php echo $button_compare; ?>">
						<i class="fa fa-retweet"></i>
						<span><?php echo $button_compare; ?></span>
					</a>	
				</div>	
				<div class="wishlist">
					<a class="btn btn-outline"  onclick="wishlist.addwishlist('<?php echo $product['product_id']; ?>');"  title="<?php echo $button_wishlist; ?>">
				...
				<div class="quickview">
					...
					<a class="pav-colorbox btn btn-outline" href="<?php echo $this->url->link("themecontrol/product",'product_id='.$product['product_id'] );?>" title="<?php echo $olang->get('quick_view'); ?>"><i class="fa fa-eye"></i>
