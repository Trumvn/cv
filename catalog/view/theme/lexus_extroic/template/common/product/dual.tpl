...
<div class="product-block item-dual" itemtype="http://schema.org/Product" itemscope>
  ...
  <div class="block-img">
    ...
    <div class="action">
      ...
      <div class="wishlist">
        <button class="btn btn-default dark" type="button" data-toggle="tooltip" data-placement="right" title="<?php echo $objlang->get("button_wishlist"); ?>" onclick="wishlist.addwishlist('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i></button> 
      </div>
      <div class="quickview">
