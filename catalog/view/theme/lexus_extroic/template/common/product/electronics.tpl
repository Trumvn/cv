		...
		<div class="right">		
			<div class="action clearfix">
				<div class="quickview col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					<a class="pav-colorbox btn btn-outline-inverse" href="<?php echo $this->url->link("themecontrol/product",'product_id='.$product['product_id'] );?>" title="<?php echo $olang->get('quick_view'); ?>"><i class="fa fa-eye"></i>
				...
				<a href="<?php echo $zimage;?>" class="info-view colorbox btn btn-outline-inverse cboxElement" title="<?php echo $product['name']; ?>"><i class="fa fa-search-plus"></i><span><?php echo $olang->get('zoom_product'); ?></span></a>
				</div>
				<?php } ?>
