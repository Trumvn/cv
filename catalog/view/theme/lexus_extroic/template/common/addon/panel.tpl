...
$headerlayouts   = array('header_haircare' => 'Header Haircare','header_healthcare' => 'Header HealthCare','header_skincare' => 'Header Skincare'); 
$productlayouts  =	array( 'default' => 'Default' , 'default_action_inner' => 'Default Action Inner', 'healthcare' => 'Health Care','skincare' => 'Skin Care' );
?>
				...
				<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" class="clearfix"><div class="clearfix">
					<div class="group-input row">
						...
						<select class="col-sm-8" name="userparams[skin]">
							...
							<option value="<?php echo ($skin);?>" <?php if( $this->getParam('skin') == $skin ) { ?> selected="selected" <?php } ?>><?php echo ($skin);?></option>
							<?php } ?>
						</select>					
					</div>
					<div class="group-input row">
					...
					<!-- <div class="group-input row">
						...
						<select class="col-sm-8" name="userparams[headerlayout]">
							<?php foreach( $headerlayouts as $k=>$skin ) {  $skin = basename($skin) ; ?>
							<option value="<?php echo ($k);?>" <?php if( $this->getParam('headerlayout') == $k ) { ?> selected="selected" <?php } ?>><?php echo ($skin);?></option>
							<?php } ?>
						</select>					
					</div> -->
