...
<div id="products" class="product-<?php echo $DISPLAY_MODE; ?>"> 
	<div class="products-block">
		...
		?>
		<div class="col-lg-<?php echo $span;?> col-md-<?php echo $span;?> col-sm-6 col-xs-<?php echo $mini;?> product-col border">			
			
			<?php require( ThemeControlHelper::getLayoutPath( 'common/product/collection.tpl' ) );  ?>   	
		</div>
